...
from .views import Display_all_products, Display_specific_product, Display_all_Reviews, Make_a_review, Search_products_category, Search_products_subcategory, Search_products, Mpesa_payment,Order_Product
...
urlpatterns = [
    ...
    path('make_order/', Order_Product.as_view(), name='make_order' ),
    path('lipa_na_saf/', Mpesa_payment.as_view(), name='lipa_na_saf' ),
